...
tfidf_file_path = os.path.join(output_folder, 'pos_1grams_tfidf.json')
...
# 保存散点图
plt.savefig(os.path.join(output_folder, 'umap_pos_1grams_scatter.png'), dpi=300, bbox_inches='tight')
plt.show()
