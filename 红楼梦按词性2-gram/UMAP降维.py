...
tfidf_file_path = os.path.join(output_folder, 'pos_2grams_tfidf.json')
...
reduced_data = umap_reducer.fit_transform(tfidf_matrix)
...
# 保存散点图
plt.savefig(os.path.join(output_folder, 'umap_pos_2grams_scatter.png'), dpi=300, bbox_inches='tight')
plt.show()
