...
tfidf_file_path = os.path.join(output_folder, 'char_3grams_tfidf.json')
...
# 保存散点图
plt.savefig(os.path.join(output_folder, 'umap_char_3grams_scatter.png'), dpi=300, bbox_inches='tight')
plt.show()
