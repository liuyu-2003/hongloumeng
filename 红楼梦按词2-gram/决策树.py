...
# 保存ROC曲线图
roc_curve_path = os.path.join(output_folder, 'roc_curve_word_2gram.png')
...
# 保存对比图
comparison_plot_path = os.path.join(output_folder, 'tsne_decision_tree_word_2grams_comparison.png')
